...
BUILD_SETTINGS = BazelBuildSettings(
    '/Users/josue/.bin/bazel',
    '/private/var/tmp/_bazel_josue/d442726bb348d0867659eb7ddf71672b/execroot/__main__',
    'ios_x86_64',
    {
        'ios_arm64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/josue/Library/Application Support/Tulsi/0.20191211.88/Bazel',
